...
#
# Generated by Vivado on Tue Dec 07 14:15:28 +0500 2021
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../rafia_fpga_core.srcs/sources_1/ip/clk_wiz_0" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../rafia_fpga_core.srcs/sources_1/ip/clk_wiz_0" \
    "$ref_dir/../../../../rafia_fpga_core.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_sim_netlist.v" \
  2>&1 | tee -a vlogan.log
